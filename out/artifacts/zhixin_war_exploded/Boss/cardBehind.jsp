...
<head>
    ...
    <link rel="stylesheet" href="../CSS/BossCss/cardBehind.css" type="text/css">
</head>
<body>
<div class="cardFrontDiv">
    <div class="cardFrontLeft">
        <p>身份证背面上传说明:</p>
        <p>此处要求上传的是身份证带有颁发单位的一面。</p>
        <p>
            <img id="cardFront" src="../images/cardBehind.png" height="180px" width="300px">
        </p>
        <p>要求上传的身份证背面图片必须是清晰的、真实的、合法的，这关乎到身份证上的个人信息是否可以被成功地识别，如果上传的图片模糊，则无法通过审核。知心招聘平台严禁用户冒用他人身份证，上传虚假信息。</p>
    </div>
    <div class="cardFrontRight">
        <div class="image-and-preview" id="show_cover">
            <div class="img-container">
                <img id="image" src="../images/cardBehind.png" height="150px" width="300px">
            </div> <!-- 盛放图片的容器-->
...
<script src="../JS/BossJs/cardBehind.js" type="text/javascript"></script>
</body>
</html>
