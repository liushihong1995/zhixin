$(function () {
    ...
    $("#getCroppedCanvas").on("click", function () {
        ...
        if(canvas == null){
            ...
            var params = '{"id":"' + id + '","image":"' + imgs + '","type":"'+ "card" +'"}';
            $.ajax({
                ...
                success: function (data) {
                    if(data==true){
                        $("#image").attr("src","/cardPic/"+ id + ".jpeg");
                        alert("上传成功");
                    }else {
                        alert("上传失败，请再次尝试！");
                    }
...
function getCard(){
    ...
    $.ajax({
        ...
        success: function (data) {
            var card = data.card;
            if(card==null || card=="") {
                $("#image").attr("src","../images/handWithCard.png");
            }else {
                $("#image").attr("src","/cardPic/" + card);
            }
        }
    });
}
...
function privous(){
    $("#cardImage").load("../Boss/cardBehind.jsp");
}
