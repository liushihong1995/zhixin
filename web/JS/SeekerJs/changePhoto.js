$(function () {
    ...
    $("#getCroppedCanvas").on("click", function () {
        ...
        if(canvas == null){
            ...
            $.ajax({
                url : "http://localhost:8080/zhixin/seeker/updatePhoto.action",
                type: "post",
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(psrc==null || psrc=="") {
                    ...
                    $("#seekerPhoto").attr("src","../images/icon_face.jpg");
                } else {
                    $("#image").attr("src","/seekerPic/" + psrc);
                    $("#seekerPhoto").attr("src","/seekerPic/" + psrc);
                }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(psrc==null || psrc=="") {
                    ...
                    $("#image").attr("src","/bossPic/" + psrc);
                    $("#seekerPhoto").attr("src","/bossPic/" + psrc);
                }
            }
        });
    }
