                        ...
                        <dl>
                            ...
                            <dd>
                                <c:forEach var="third" items="${second.value}">
                                    <a href="http://localhost:8080/zhixin/seeker/searchJobWithCondition.action?cateId=${third.value}&cateName=${third.key}&compName=default&city=default">${third.key}</a>
                                </c:forEach>
                            </dd>
                        </dl>
                    </c:forEach>
